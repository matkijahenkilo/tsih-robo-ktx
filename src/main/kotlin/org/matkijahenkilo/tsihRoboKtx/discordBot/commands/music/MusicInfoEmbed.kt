...
import org.matkijahenkilo.tsihRoboKtx.discordBot.commands.music.audio.TrackScheduler
...
object MusicInfoEmbed {
    ...
    private val repeat = primary(Music.REPEAT, emoji = Emoji.fromUnicode("🔂"))
    private val shuffle = primary(Music.SHUFFLE, emoji = Emoji.fromUnicode("🔀"))
